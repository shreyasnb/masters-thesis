...
% \usepackage[sc]{mathpazo}     % Serif (Caslon substitute)
% \usepackage[scaled=0.9]{helvet} % Sans-serif (Optima substitute)
\usepackage[scaled=0.85]{inconsolata} % Monospace (Envy substitute)
